...
/******/ 			var chunk = require("./" + ({"1":"components/app-header","2":"components/app-header1","3":"components/error-msg","4":"components/home","5":"components/user-header","6":"components/user-login","7":"components/user-registration","8":"pages/CreatePost","9":"pages/Posts","10":"pages/Register","11":"pages/UserHome","12":"pages/UserProfile","13":"pages/index"}[chunkId]||chunkId) + ".js");
...
const actions = {
  async UserRegistration({
    ...
    try {
      const response = await this.$axios.post('user/register', Data).then(res => {
        console.log(res.data);
      });
    } catch (error) {
      var _error$response$data, _error$response;

      console.log((_error$response$data = (_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.data) !== null && _error$response$data !== void 0 ? _error$response$data : error.message);
      console.log(error);
  ...
  async CommentPost({
    ...
    const res = await this.$axios.post('comment/post_id?post_id=' + data.postId, {
...
__webpack_require__.d(components_namespaceObject, "AppHeader1", function() { return AppHeader1; });
__webpack_require__.d(components_namespaceObject, "ErrorMsg", function() { return ErrorMsg; });
...
__webpack_require__.d(components_namespaceObject, "UserRegistration", function() { return UserRegistration; });
...
const middleware = {};
middleware['route-guard'] = __webpack_require__(17);
...
const _cfde0dd8 = () => interopDefault(__webpack_require__.e(/* import() | pages/CreatePost */ 8).then(__webpack_require__.bind(null, 43)));

const _716d3faa = () => interopDefault(__webpack_require__.e(/* import() | pages/Posts */ 9).then(__webpack_require__.bind(null, 44)));

const _0cde870a = () => interopDefault(__webpack_require__.e(/* import() | pages/Register */ 10).then(__webpack_require__.bind(null, 45)));

const _149a59a2 = () => interopDefault(__webpack_require__.e(/* import() | pages/UserHome */ 11).then(__webpack_require__.bind(null, 46)));

const _6d51bb94 = () => interopDefault(__webpack_require__.e(/* import() | pages/UserProfile */ 12).then(__webpack_require__.bind(null, 47)));

const _b171546c = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 13).then(__webpack_require__.bind(null, 48)));
...
const AppHeader = () => __webpack_require__.e(/* import() | components/app-header */ 1).then(__webpack_require__.bind(null, 29)).then(c => wrapFunctional(c.default || c));
const AppHeader1 = () => __webpack_require__.e(/* import() | components/app-header1 */ 2).then(__webpack_require__.bind(null, 38)).then(c => wrapFunctional(c.default || c));
const ErrorMsg = () => __webpack_require__.e(/* import() | components/error-msg */ 3).then(__webpack_require__.bind(null, 42)).then(c => wrapFunctional(c.default || c));
const Home = () => __webpack_require__.e(/* import() | components/home */ 4).then(__webpack_require__.bind(null, 40)).then(c => wrapFunctional(c.default || c));
const UserHeader = () => __webpack_require__.e(/* import() | components/user-header */ 5).then(__webpack_require__.bind(null, 25)).then(c => wrapFunctional(c.default || c));
const UserLogin = () => __webpack_require__.e(/* import() | components/user-login */ 6).then(__webpack_require__.bind(null, 41)).then(c => wrapFunctional(c.default || c));
const UserRegistration = () => __webpack_require__.e(/* import() | components/user-registration */ 7).then(__webpack_require__.bind(null, 39)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
...
/* harmony default export */ var _nuxt_axios = ((ctx, inject) => {
  ...
  const baseURL =  false ? undefined : runtimeConfig.baseURL || runtimeConfig.baseUrl || process.env._AXIOS_BASE_URL_ || 'http://52.198.140.122:5000/api/'; // Create fresh objects for all default header scopes
